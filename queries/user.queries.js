const userQueries = {
    insertUser: `INSERT INTO tdp.users(
     user_name, user_password, user_email, user_full_name, date_of_birth, profile_picture, created_at, updated_at, is_deleted)
    ...
    updateUser: `UPDATE tdp.users 
        SET user_name = $2, user_email = $3, user_full_name = $4, date_of_birth = $5, profile_picture = $6, updated_at = $7
